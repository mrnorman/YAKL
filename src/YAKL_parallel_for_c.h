...
namespace yakl {
  namespace c {
    ...
    /**
     * @brief [ASYNCHRONOUS] Same as the other form of yakl::c::parallel_for but without the string label.
     */
    template <class F, int N, bool simple, int VecLen=YAKL_DEFAULT_VECTOR_LEN , bool B4B = false>
    ...
    /**
     * @brief [ASYNCHRONOUS] Same os the other form of yakl::c::parallel_outer but without the string label.
     */
    template <class F, int N, bool simple, int VecLen=YAKL_DEFAULT_VECTOR_LEN, bool B4B = false>
    ...
    /**
     * @brief [ASYNCHRONOUS] For hierarchical (two-level) parallelism only. **Must be called from within a yakl::c::parallel_outer call.**
