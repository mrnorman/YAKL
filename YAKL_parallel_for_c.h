...
namespace c {
  ...
  template <class F> inline void parallel_for_openmp_dev( int ubnd , F const &f , int vectorSize = 128 ) {
    #pragma omp target teams distribute parallel for collapse(1)
    for (int i0 = 0; i0 < ubnd; i0++) {
      f( i0 );
    }
  }
  template <class F> inline void parallel_for_openmp_dev( LBnd &bnd , F const &f , int vectorSize = 128 ) {
    #pragma omp target teams distribute parallel for collapse(1)
    for (int i0 = bnd.l; i0 < bnd.l+(bnd.u-bnd.l+1); i0+=bnd.s) {
      f( i0 );
    }
  }
  template <class F> inline void parallel_for_openmp_dev( Bounds<1,false> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(1)
    for (int i0 = bounds.lbounds[0]; i0 < bounds.lbounds[0]+bounds.dims[0]; i0+=bounds.strides[0]) {
      f( i0 );
    }
  }
  template <class F> inline void parallel_for_openmp_dev( Bounds<2,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<3,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<4,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<5,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<6,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<7,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<8,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<2,true> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(2)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<3,true> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(3)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<4,true> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(4)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<5,true> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(5)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<6,true> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(6)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<7,true> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(7)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp_dev( Bounds<8,true> const &bounds , F const &f ) {
    #pragma omp target teams distribute parallel for collapse(8)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp( int ubnd , F const &f , int vectorSize = 128 ) {
    #pragma omp parallel for collapse(1)
    for (int i0 = 0; i0 < ubnd; i0++) {
      f( i0 );
    }
  }
  template <class F> inline void parallel_for_openmp( LBnd &bnd , F const &f , int vectorSize = 128 ) {
    #pragma omp parallel for collapse(1)
    for (int i0 = bnd.l; i0 < bnd.l+(bnd.u-bnd.l+1); i0+=bnd.s) {
      f( i0 );
    }
  }
  template <class F> inline void parallel_for_openmp( Bounds<1,false> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(1)
    for (int i0 = bounds.lbounds[0]; i0 < bounds.lbounds[0]+bounds.dims[0]; i0+=bounds.strides[0]) {
      f( i0 );
    }
  }
  template <class F> inline void parallel_for_openmp( Bounds<2,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<3,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<4,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<5,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<6,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<7,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<8,false> const &bounds , F const &f ) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<1,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(1)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
      f( i0 );
    }
  }
  template <class F> inline void parallel_for_openmp( Bounds<2,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(2)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
      f( i0 , i1 );
  ...
  template <class F> inline void parallel_for_openmp( Bounds<3,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(3)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<4,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(4)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<5,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(5)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<6,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(6)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<7,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(7)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
  ...
  template <class F> inline void parallel_for_openmp( Bounds<8,true> const &bounds , F const &f ) {
    #pragma omp parallel for collapse(8)
    for (int i0 = 0; i0 < bounds.dims[0]; i0++) {
    for (int i1 = 0; i1 < bounds.dims[1]; i1++) {
    for (int i2 = 0; i2 < bounds.dims[2]; i2++) {
