...
export CTEST_BUILD_NAME=main-nvidia-debug
...
export CTEST_CUDA_FLAGS="-O0 -g -DYAKL_DEBUG -arch sm_80 -ccbin CC -DTHRUST_IGNORE_CUB_VERSION_CHECK"
export CTEST_C_FLAGS="-O0 -g -DYAKL_DEBUG"
export CTEST_F90_FLAGS="-O0 -g -DYAKL_DEBUG"
