...
The YAKL API is similar to Kokkos. It is simplified in many ways to make adding multiple hardware backends easier. Yet, YAKL's increase simplicity allows it to do some things other frameworks cannot such as provide Fortran interoperability, lighter weight exposure of atomics, abstract host-to-device and device-to-host transfers for you, and more easily interoperate with external libraries such as MPI and I/O libraries. 
