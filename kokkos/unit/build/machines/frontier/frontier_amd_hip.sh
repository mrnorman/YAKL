...
cmake -Wno-dev                        \
      ...
      -DYAKL_UNIT_CXX_FLAGS="-DHAVE_MPI;-DPORTURB_GPU_AWARE_MPI;-DPORTURB_FUNCTION_TIMERS;-munsafe-fp-atomics;-O3;-ffast-math;-I${ROCM_PATH}/include;-D__HIP_ROCclr__;-D__HIP_ARCH_GFX90A__=1;-Wno-unused-result;-Wno-macro-redefined" \
