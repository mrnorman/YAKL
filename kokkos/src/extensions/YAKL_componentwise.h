...
namespace yakl {
  ...
  namespace componentwise {
    ...
    add_array_scalar( Array<T1,N,memDevice,STYLE> const &left , T2 const &right ) {
      ...
      c::parallel_for( YAKL_AUTO_LABEL() , ret.totElems() , KOKKOS_LAMBDA (int i) { ret.data()[i] = left.data()[i] + right; });
      return ret;
    }
    template <class T1, class T2, int N, int STYLE,
              typename std::enable_if<std::is_arithmetic<T2>::value,bool>::type = false>
    ...
    template <class T1, class T2, int N, class B0, class B1, class B2, class B3,
              typename std::enable_if<std::is_arithmetic<T2>::value,bool>::type = false>
    KOKKOS_INLINE_FUNCTION FSArray<decltype(T1()+T2()),N,B0,B1,B2,B3>
    ...
    add_scalar_array( T1 const &left , Array<T2,N,memDevice,STYLE> const &right ) {
      ...
      c::parallel_for( YAKL_AUTO_LABEL() , ret.totElems() , KOKKOS_LAMBDA (int i) { ret.data()[i] = left + right.data()[i]; });
      return ret;
    }
    template <class T1, class T2, int N, int STYLE,
              typename std::enable_if<std::is_arithmetic<T1>::value,bool>::type = false>
    ...
    operator+( Array<T1,N,memDevice,STYLE> const &left , Array<T2,N,memDevice,STYLE> const &right ) {
      auto ret = left.template createDeviceObject<decltype(T1()+T2())>();
      c::parallel_for( YAKL_AUTO_LABEL() , ret.totElems() , KOKKOS_LAMBDA (int i) { ret.data()[i] = left.data()[i] + right.data()[i]; });
      return ret;
    }
    template <class T1, class T2, int N, size_t D0, size_t D1, size_t D2, size_t D3>
    KOKKOS_INLINE_FUNCTION SArray<decltype(T1()+T2()),N,D0,D1,D2,D3>
    ...
    operator!( Array<T1,N,memDevice,STYLE> const &left ) {
      ...
      c::parallel_for( YAKL_AUTO_LABEL() , ret.totElems() , KOKKOS_LAMBDA (int i) { ret.data()[i] = ! left.data()[i]; });
      return ret;
    }
    ...
    operator++( Array<T1,N,memDevice,STYLE> const &left ) {
      ...
      c::parallel_for( YAKL_AUTO_LABEL() , ret.totElems() , KOKKOS_LAMBDA (int i) { ret.data()[i] = left.data()[i]+1; });
      return ret;
    }
    template <class T1, int N, size_t D0, size_t D1, size_t D2, size_t D3>
    ...
    template <class T1, int N, class B0, class B1, class B2, class B3>
    KOKKOS_INLINE_FUNCTION FSArray<decltype(T1()+1),N,B0,B1,B2,B3>
    operator++( FSArray<T1,N,B0,B1,B2,B3> const &left ) {
