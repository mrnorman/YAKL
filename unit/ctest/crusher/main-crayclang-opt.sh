...
export CTEST_BUILD_NAME=main-crayclang-opt
...
export CTEST_HIP_FLAGS="-O3 -DYAKL_ENABLE_STREAMS -Wno-tautological-pointer-compare -Wno-unused-result -D__HIP_ROCclr__ -D__HIP_ARCH_GFX90A__=1 --rocm-path=${ROCM_PATH} --offload-arch=gfx90a -x hip"
export CTEST_C_FLAGS="-O3"
export CTEST_F90_FLAGS="-O3 -L${ROCM_PATH}/lib -lamdhip64"
