...
int main() {
  yakl::init();
  {
    ...
    // This block is the writing phase
    {
      ...
      Array<          char,1,memDevice,styleC      > a0("a0",d1);
      Array<unsigned  char,2,memDevice,styleFortran> a1("a1",d1,d2);   // TODO: Fortran write1 seems to fail
      ...
      Array<          long,7,memHost  ,styleC      > a6("a6",d7,d6,d5,d4,d3,d2,d1);
      Array<unsigned  long,8,memHost  ,styleFortran> a7("a7",d1,d2,d3,d4,d5,d6,d7,d8);
    ...
    // This block is the reading phase
    {
      ...
      Array<           int,5,memDevice,styleC      > a4("a4",d5,d4,d3,d2,d1);
      Array<unsigned   int,6,memHost  ,styleFortran> a5("a5",d1,d2,d3,d4,d5,d6);
      Array<          long,7,memDevice,styleFortran> a6("a6",d1,d2,d3,d4,d5,d6,d7);
      Array<unsigned  long,8,memHost  ,styleFortran> a7("a7",d1,d2,d3,d4,d5,d6,d7,d8);
      Array<         float,3,memDevice,styleFortran> a8("a8",d1,d2,d3);
      Array<        double,3,memHost  ,styleFortran> a9("a9",d1,d2,d3);
      float s0 = -999;
      int   s1 = -999;
      Array<          char,2,memDevice,styleC      > a0_unlim("a0_unlim",num_entries,d1);
      ...
      Array<          long,8,memDevice,styleFortran> a6_unlim("a6_unlim",d1,d2,d3,d4,d5,d6,d7,num_entries);
      // Array<unsigned  long,9,memHost  ,styleFortran> a7_unlim("a7_unlim",d1,d2,d3,d4,d5,d6,d7,d8,num_entries);
      ...
      if ( s0 != 1 ) die("ERROR: s0 should be 1");
      if ( s1 != 2 ) die("ERROR: s1 should be 2");
      ...
      // if ( sum(a7_unlim) / size(a7_unlim) != 7 ) die("ERROR: avg of a7_unlim should be 7");
