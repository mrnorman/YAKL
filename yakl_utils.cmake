...
macro(yakl_process_cxx_source_files files)
  if ("${YAKL_ARCH}" STREQUAL "CUDA")
    ...
    set(YAKL_COMPILER_FLAGS "-DYAKL_ARCH_CUDA --expt-extended-lambda --expt-relaxed-constexpr -Wno-deprecated-gpu-targets -DTHRUST_IGNORE_CUB_VERSION_CHECK -std=c++17 ${YAKL_CUDA_FLAGS}")
  elseif ("${YAKL_ARCH}" STREQUAL "HIP")
    set(YAKL_COMPILER_FLAGS "-DYAKL_ARCH_HIP ${YAKL_HIP_FLAGS}")
  elseif ("${YAKL_ARCH}" STREQUAL "SYCL")
    set(YAKL_COMPILER_FLAGS "-DYAKL_ARCH_SYCL -qmkl ${YAKL_SYCL_FLAGS}")
